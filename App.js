    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen name="my_addresses" component={MyAddressesScreen} options={{ headerShown: false }} />
          <Stack.Screen name="favourite_orders" component={FavouriteOrdersScreen} options={{ headerShown: false }} />
          <Stack.Screen name="book_marks" component={BookmarksScreen} options={{ headerShown: false }} />
          <Stack.Screen name="notifications" component={NotificationsScreen} options={{ headerShown: false }} />
          <Stack.Screen name="settings" component={SettingsScreen} options={{ headerShown: false }} />
          <Stack.Screen name="payment_settings" component={PaymentSettingsScreen} options={{ headerShown: false }} />
        </Stack.Navigator>
      </NavigationContainer>
